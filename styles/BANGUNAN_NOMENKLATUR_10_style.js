...
var style_BANGUNAN_NOMENKLATUR_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_BANGUNAN_NOMENKLATUR_10_eval_expression(context) !== null) {
        labelText = String(exp_label_BANGUNAN_NOMENKLATUR_10_eval_expression(context));
    }
